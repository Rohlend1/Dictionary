...
import org.example.dictionary.dict.finder.AddDocumentRequest;
import org.example.dictionary.dict.finder.AddDocumentResponse;
...
public class DocumentController {
    ...
    @PostMapping
    public AddDocumentResponse addDocument(@RequestBody AddDocumentRequest body){
        AddDocumentResponse response = grpc.getStub().addDocument(body);
